...
-- MATERIALIZE INDEX runs. The app used to submit that backfill at startup; it no longer
-- exists, because the index is now inline in init-clickhouse.sql and every part is
-- indexed on insert. To backfill manually:
