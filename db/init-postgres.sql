...
CREATE TABLE IF NOT EXISTS comments (
    ...
    query TEXT DEFAULT '',             -- Quandrix query active when comment was created
    created_at TIMESTAMP NOT NULL DEFAULT NOW(),
...
-- Add query column to comments (stores the active Quandrix query when comment was created)
