...
func WriteAllFiles(cfg *SetupConfig) error {
	...
	// No init-clickhouse.sql is written: the app provisions the ClickHouse schema from
	// its embedded copy and stamps the migration table in the same step. A copy on disk
