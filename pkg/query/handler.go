...
type QueryRequest struct {
	...
	QueryType string `json:"query_type,omitempty"` // reserved, always treated as "quandrix"
...
func (h *QueryHandler) HandleQuery(w http.ResponseWriter, r *http.Request) {
	...
	log.Printf("[QueryHandler] Processing Quandrix query")
	...
	go h.logQueryAudit(req.Query, "quandrix", selectedIndex, username, executionTime, len(results))
