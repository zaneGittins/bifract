	...
	response := ReferenceResponse{
		Functions: []FunctionDoc{
			...
			},
			{
				...
				Syntax:      `| pgr(start="<process_guid>", depth=N, direction=forward|backward|both, threshold=0.0-1.0, reconnect=true|false, diffuse=true|false, lambda=0.0-1.0, exclude="file_write,net_connect", limit=N)`,
				Parameters: []Param{
					{Name: "start", Type: "string", Required: true, Description: "process_guid of the seed node"},
