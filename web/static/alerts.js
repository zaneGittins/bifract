...
const Alerts = {
    ...
    showActionsManageView() {
        ...
        this.loadWebhooks();
        this.loadFractalActionsForManage();
        this.loadDictActionsForManage();
    },
...
throttleField: ${alert.throttle_field}` : ''}`;
    ...
    toggleAlertPanel() {
        ...
        if (panel && mainContent) {
            ...
            if (isOpen) {
                ...
                if (toggleBtn) toggleBtn.textContent = 'Configure Alert';
            } else {
                panel.classList.add('open');
    ...
    async loadAlertIntoEditor(alertId) {
        try {
            ...
            if (this.editingFeedAlert) {
                ...
                const editorHeader = document.querySelector('.alert-editor-header');
    ...
    async loadActionsIntoEditor() {
        ...
        try {
            const [webhooksResp, actionsResp, dictActionsResp] = await Promise.all([
    ...
    async deleteFractalAction(fractalActionId) {
        ...
        try {
            ...
            this.loadFractalActionsForManage(); // Refresh the list
