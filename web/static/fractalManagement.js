const FractalManagement = {
    ...
    async refreshSingleFractalStats() {
        ...
        try {
            ...
            if (window.Toast) {
                Toast.success('Statistics Updated', 'Fractal statistics have been refreshed');
            }
    ...
    async executeDeleteFractal(fractalId) {
        ...
        try {
            ...
            if (window.Toast) {
                Toast.success('Fractal Deleted', `Fractal "${this.currentDetailFractal.name}" has been deleted`);
            }
    ...
    async executeClearFractalLogs(fractalId) {
        ...
        try {
            ...
            if (data.success) {
                if (window.Toast) {
                    Toast.success('Success', data.message || `All logs for fractal "${this.currentDetailFractal.name}" have been cleared`);
                }
